...
export default function MyCommentsListCardComponent({
  ...
  const handleDeleteComment = async (comment_id: number
      ...
      if (window.confirm('確定要刪除留言嗎？此操作無法復原喔！')) {
        try {
          const res = await fetch('http://localhost:3001/api/posts/delete-comment', {
            method: 'DELETE',
            headers: {
  ...
  return (
    <>
      <div className="flex gap-2 py-4 items-center justify-between">
                ...
                <div className="card-body p-2">
                  <div className="flex items-center">
                    <div className="aspect-video min-w-[64px] me-2">
                      <Image src={article_img_url || '/imgs/test.png'}
                             alt="文章圖片"
                             width={64}
                             height={36}
                      />
                      ...
                      <div className="flex justify-between items-center">
                        <div className="avatar me-2">
                          <div className="w-6 rounded-full">
                            <Image src={author_avatar_url || '/imgs/cat.png'}
                                   alt="大頭貼圖"
                                   width={48}
                                   height={48}
                            />
        ...
        <div
          className="flex justify-end  w-1/12 text-xl ">
          <FaTrashCan className="text-gray-400 hover:cursor-pointer hover:text-gray-500 active:text-gray-700"
