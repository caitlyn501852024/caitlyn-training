        ...
        <div className="container">
          ...
          <div className="text-center">
            ...
            <div className='flex justify-center gap-5'>
              <button className="inline-block border border-black rounded-md px-4 py-2.5 hover:bg-gray-200 active:bg-gray-300">取消發表</button>
              <button className="inline-block bg-primary text-white font-bold rounded-md px-4 py-2.5 hover:bg-primary-500 active:bg-primary-700">發表文章</button>
            </div>
          </div>
        </div>
      </main>
